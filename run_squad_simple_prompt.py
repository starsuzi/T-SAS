...
question_answering_column_name_mapping = {
    ...
    "covid_qa_deepset": ("question", "context", "answer"),
    "pubmed_qa": ("question", "context", "long_answer"),
    "sciq": ("question", "support", "correct_answer")
}
...
def main():
    ...
    if args.context_column is None:
    ...
    def preprocess_function(examples):
        ...
        examples[question_column] =  ['Question: {}\n '.format(q.lstrip()) for q in examples[question_column]] #[q.lstrip() for q in examples[question_column]]
    ...
    def prepare_validation_features(examples):
        ...
        # ("Answer a question about this article:\n{context}\n{question}", "{answer}"),
        #examples[question_column] =  ['Please answer a question about the following article. Question: {}\n Article: '.format(q.lstrip()) for q in examples[question_column]] #[q.lstrip() for q in examples[question_column]]
        examples[question_column] =  ['Question: {} '.format(q.lstrip()) for q in examples[question_column]] #[q.lstrip() for q in examples[question_column]]
        #import pdb; pdb.set_trace()
        examples[context_column] = ['Context: ' + c.lstrip()  for c in examples[context_column]]
