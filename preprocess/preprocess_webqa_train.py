...
with open('./data/webqa/original/dpr/biencoder-webquestions-train.json', 'r') as input_file:
...
with open("./data/webqa/preprocessed/webqa_train.json", "w") as output_file:
