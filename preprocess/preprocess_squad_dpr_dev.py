...
with open('/data/syjeong/prompt_test/data/squad_dpr/original/dpr/biencoder-squad1-dev.json', 'r') as input_file:
...
with open("./data/squad_dpr/preprocessed/squad_dpr_dev.json", "w") as output_file:
