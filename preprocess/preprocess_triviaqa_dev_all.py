...
with open('/data/syjeong/prompt_test/data/trivia/original/dpr/biencoder-trivia-dev.json', 'r') as input_file:
...
with open("/data/syjeong/prompt_test/data/trivia/preprocessed/trivia_dev_all.json", "w") as output_file:
