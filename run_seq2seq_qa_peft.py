...
def main():
    ...
    # Setup logging
    logging.basicConfig(        
        filename=training_args.output_dir+'/logs.log', # 
        filemode='w',
    ...
    if data_args.dataset_name is not None:
        ...
        # raw_datasets = load_dataset('natural_questions', 'default', beam_runner='DirectRunner')
    else:
        data_files = {}
    ...
    if training_args.do_train or training_args.do_eval_noFinetune:
