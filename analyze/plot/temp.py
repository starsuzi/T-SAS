...
######################################################
value_a = [44.85]    # DPR (only_inbatch_32)
value_b = [45.46]    # QA (gen_only_inbatch_32)
...
plt.savefig("/data/syjeong/prompt_test/analyze/plot/plot_outputs/temp.pdf", bbox_inches="tight", pad_inches=0)
plt.savefig("/data/syjeong/prompt_test/analyze/plot/plot_outputs/temp.png", bbox_inches="tight", pad_inches=0)
