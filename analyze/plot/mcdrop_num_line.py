...
df=pd.DataFrame({'x_values': x1, 'T-SAS': thres5, 'T-SAS w/o M.V.':[74.0995440289053] * len(thres5)})

# multiple line plots
plt.plot( 'x_values', 'T-SAS', "bo--", linewidth=2, markersize=9, data=df)
plt.plot( 'x_values', 'T-SAS w/o M.V.', color='red', marker='', linewidth=2, markersize=10, data=df)
...
plt.ylim([71, 75.5])
plt.gca().yaxis.set_ticks([71,  72.5, 74, 75.5])
