...
def parse_args():
    ...
    parser.add_argument("--do_peft", action="store_true")
...
def main():
    ...
    def post_processing_function(
        ...
        references = [{"id": ex["id"], "answers": ex[answer_column] if ex[answer_column]['text'] != [] else {'text': [''], 'answer_start': []}} for ex in examples]
